...
namespace Infra.ApplicationServices.Utility
{
    ...
    {
        public const string ISSUER = "https://communere.com/";
        public const string AUDIENCE = "https://communere.com/";
        ...
        private static SecurityTokenDescriptor FillToken(string secret, User user)
        {
            ...
            return new SecurityTokenDescriptor
            {
                ...
                {
                    new Claim(CommunereClaimTypes.Id, user.Id.ToString()),
                    new Claim(ClaimTypes.Name, $"{user.FirstName} {user.LastName}"),
                    new Claim(CommunereClaimTypes.Username, user.Username),
                }),
